    ...
    async def async_step_user(
        ...
        if user_input:
            ...
            try:
                ...
                _LOGGER.error(
                    "Connection Error at async_step_user. %s: %s", e.__class__.__qualname__, e
                )
    ...
    async def async_step_verify_mfa(
        ...
        if user_input and isinstance(self._client, RESTClient):
            ...
            try:
                ...
                _LOGGER.error("Connection Error at verify_mfa. %s: %s", e.__class__.__qualname__, e)
                errors["base"] = "mfa_error"
            except IncompleteAccountError as e:
                if self._client:
                    try:
                        ...
                        pass
                _LOGGER.error(
                    "Account Setup Incomplete at verify_mfa. %s: %s", e.__class__.__qualname__, e
                )
                return self.async_abort(reason="incomplete_account")
    ...
    async def async_step_reauth_confirm(
        ...
        if user_input:
            ...
            try:
                ...
                _LOGGER.error(
                    "Connection Error at reauth_confirm. %s: %s", e.__class__.__qualname__, e
                )
                errors["base"] = "authentication_error"
            except IncompleteAccountError as e:
                if self._client:
    ...
    async def async_step_reauth_verify_mfa(
        ...
        if user_input and isinstance(self._client, RESTClient):
            ...
            try:
                ...
                _LOGGER.error(
                    "Connection Error at reauth_verify_mfa. %s: %s", e.__class__.__qualname__, e
                )
                errors["base"] = "mfa_error"
            except IncompleteAccountError as e:
                if self._client:
